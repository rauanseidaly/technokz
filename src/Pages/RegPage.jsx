        ...
        <div>
            ...
            <div>
                <div className='container'>
                    <div>
                        <div style={{ textAlign: 'center', fontWeight: 'bolder', color: 'grey' }}>Fill up for registration</div>
                    </div>
                    <div>
                        <div style={{ textAlign: 'center', fontWeight: 'bolder', color: 'grey' }}>Already have account? Just Login</div>
                    </div>
                    <div>
            ...
            <div className='modal' >
                <div className="modal-dialog">
                    <div className="modal-header">
                        <div className="modal-title">fill up the form to contact us</div>
                    </div>
                    <div className="modal-body">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='input-block'>
                                ...
                                <textarea name='message' value={values.message} onChange={handleChange} onBlur={handleBlur} rows='10' cols='50' id='text' placeholder='tell us about your query regarding your order or product ' className='form-control' ></textarea>
                                {errors.message && touched.message ? <p className='text-danger'>{errors.message}</p> : null}
                            </div>

                            <div className='d-flex'>
                                <button type='reset' className='btn btn-secondary align-self-start mx-auto' > Reset </button>
                                <button type='submit' className='btn btn-primary align-self-end mx-auto' > Submit </button>
                            </div>
